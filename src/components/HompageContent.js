    ...
    <div className='flex flex-col justify-center'>
      <div className='flex flex-col justify-center p-2'>
        ...
        <Modal 
          ...
          onRequestClose={() => setMoreInfoOpen(false)} 
          contentLabel="More Info"
          className="fixed inset-0 flex items-center justify-center p-4"
        >
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md max-h-[80vh] overflow-y-auto">
            <h5 className="text-lg font-bold mb-4">More about Get Up and Move</h5>
        ...
        >
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md max-h-[80vh] overflow-y-auto">
            <h2 className="text-xl font-bold mb-4">Fitness and Exercise Disclaimer</h2>
            <div className="modal-body text-sm">
